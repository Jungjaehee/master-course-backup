...
class TransformerModel(nn.Module):
    def __init__(self, n_speakers, in_size, n_heads, n_units, n_layers, dim_feedforward=1024, dropout=0.5, has_pos=False):
    ...
    def forward(self, src, has_mask=False, activation=None):
        ...
        return frame_embedding, output  # frame-wise embedding, output value(posteriors)
