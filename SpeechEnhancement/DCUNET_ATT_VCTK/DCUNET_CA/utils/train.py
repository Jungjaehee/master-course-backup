...
from utils.loss_func import SI_SNR, Weighted_SDR
    ...
    try:
        ...
        while True:
            ...
            for target_wav, mixed_spec, target_spec in trainloader:
                ...
                # Combine loss
                # loss = si_snr(target_wav, enhanced_wav) + 100*mse(target_mag, output_mag)
                ...
                if step % 1000 == 0:
                    validate(hp, args.output_model, audio, model, testloader, writer, step)
